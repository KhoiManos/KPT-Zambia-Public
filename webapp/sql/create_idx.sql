...
CREATE INDEX IF NOT EXISTS idx_exact_meas_id_time ON exact_measurement (exact_id, "timestamp");
CREATE INDEX IF NOT EXISTS idx_fuel_meas_id_time ON fuel_measurement (fuel_id, "Timestamp");
...
CREATE INDEX IF NOT EXISTS idx_exact_meta_stove ON exact_meta (stove_name);
CREATE INDEX IF NOT EXISTS idx_fuel_meta_type ON fuel_meta (fuel_type);